...
angular.module('angucomplete-alt', [] )
  ...
  $templateCache.put(TEMPLATE_URL,
      ...
      '  <input id="[[id]]_value" name="[[id]]_value" ng-model="searchStr" ng-disabled="disableInput" type="text" placeholder="[[placeholder]]" ng-focus="onFocusHandler()" class="[[inputClass]]" ng-focus="resetHideResults()" ng-blur="hideResults($event)" autocapitalize="off" autocorrect="off" autocomplete="off" ng-change="inputChangeHandler(searchStr)"/>' +
